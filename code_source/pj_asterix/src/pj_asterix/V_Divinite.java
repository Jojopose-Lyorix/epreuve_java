   ...
   private DefaultTableModel dm_tb_Divinites;
    ...
    private void ihm(char mode) {
        if (mode == 'T') {
            ...
            // ← MODIFICATION : Gérer l'affichage des boutons selon le rôle
            if (idRole == 3) {
    ...
    if (isModif) {
        int vidivi = Integer.parseInt(tx_id.getText());
        ...
        if (reponse == JOptionPane.YES_OPTION) {
            try {
                controler.enregistrer_divi(vidivi, vNom, vCom, vCon);
